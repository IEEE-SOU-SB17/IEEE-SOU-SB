            ...
            <div className="mb-12">
              ...
              >
                <img
                  ...
                  className="w-36 h-36 rounded-full object-cover border-4 border-primary flex-shrink-0"
                />
                <div>
              ...
              {otherMembers.map((member) => (
                ...
                >
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-32 h-32 rounded-full object-cover mb-4 border-2 border-muted dark:border-gray-700"
                  />
